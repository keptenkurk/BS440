...
# About:
# Python plugin which receives data from a Medisana BS4xx Bluetooth scale and does 
...
#
# Owner: Specify the owner and contact details. Plugins will not be maintained by the
